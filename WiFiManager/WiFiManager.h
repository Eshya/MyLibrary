...
class WiFiManagerParameter {
  public:
    ...
    */
    ...
    WiFiManagerParameter(char *custom);
    WiFiManagerParameter(const char *id, const char *label);
    WiFiManagerParameter(const char *id, const char *label, const char *defaultValue, int length);
    WiFiManagerParameter(const char *id, const char *label, const char *defaultValue, int length, char *custom);
    WiFiManagerParameter(const char *id, const char *label, const char *defaultValue, int length, char *custom,const char *id2, const char *label2, const char *defaultValue2, int length2);
    WiFiManagerParameter(const char *id, const char *label, const char *defaultValue, int length, char *custom, int labelPlacement);
    ~WiFiManagerParameter();
    ...
    void        setValue2(const char *defaultValue2, int length2);

  protected:
    void init(const char *id, const char *label, const char *defaultValue, int length, char *custom, int labelPlacement);
    void init2(const char *id, const char *label, const char *defaultValue, int length, char *custom, const char *id2, const char *label2, const char *defaultValue2, int length2);
