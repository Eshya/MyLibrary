...
const char HTTP_FORM_PARAM2[]      PROGMEM = "<br/><input style='width:20%;' type='checkbox' id='{i}' name='{n}' maxlength={l}  value='{v}' {c}><label style='width:10%;' for='{fr}'>TOPIC</label><span> : </span> <input style='width:50%;' id='{i2}' name='{n2}' length='{l2}'  value='{v2}' ></br>";
