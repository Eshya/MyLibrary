...
AsyncWiFiManagerParameter::AsyncWiFiManagerParameter(const char *id, const char *label, const char *defaultValue, int length,  char *custom,const char *id2, const char *label2, const char *defaultValue2, int length2) {
...
void AsyncWiFiManagerParameter::init2(const char *id, const char *label, const char *defaultValue, int length, char *custom,const char *id2, const char *label2, const char *defaultValue2, int length2){
  _id             = id;
  _label          = label;
  _labelPlacement = WFM_LABEL_BEFORE;
  _customHTML     = custom;
...
void AsyncWiFiManagerParameter::setValue2(const char *defaultValue2, int length2) {
  if(!_id2){
    // Serial.println("cannot set value of this parameter");
    return;
  }
...
const char* AsyncWiFiManagerParameter::getValue2() {
  // Serial.println(printf("Address of _value is %p\n", (void *)_value)); 
  return _value2;
}
const char* AsyncWiFiManagerParameter::getID2() {
  return _id2;
}
const char* AsyncWiFiManagerParameter::getLabel2() {
  return _label2;
}
int AsyncWiFiManagerParameter::getValueLength2() {
  return _length2;
}
